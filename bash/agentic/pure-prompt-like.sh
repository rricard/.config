...
_prompt_build() {
  ...
  local rl=$'\001' rr=$'\002'
  local reset="${rl}$(printf '\e[0m')${rr}"
  local blue="${rl}$(printf '\e[34m')${rr}"
  local gray="${rl}$(printf '\e[38;5;242m')${rr}"
  local pink="${rl}$(printf '\e[38;5;218m')${rr}"
  local magenta="${rl}$(printf '\e[35m')${rr}"
  local red="${rl}$(printf '\e[31m')${rr}"
